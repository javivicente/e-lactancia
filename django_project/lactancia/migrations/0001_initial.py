    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Es parte de la URL. Se crea autom\xe1ticamente a partir del nombre en ingl\xe9s. Si no lo hay, se crear\xe1 a partir de la versi\xf3n en espa\xf1ol. El sistema se asegurar\xe1 de que sea \xfanico. Ejemplo: Epinephrine -> epinephrine para http://e-lactancia/breastfeeding/epinephrine/synonym.', max_length=100, verbose_name='Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Es parte de la URL. Se crea autom\xe1ticamente a partir del nombre del grupo en ingl\xe9s. El sistema se asegurar\xe1 de que sea \xfanico. Ejemplo: Anti-dementia Drug -> anti-dementia-drug  http://e-lactancia/breastfeeding/anti-dementia-drug/group/.', max_length=100, verbose_name='Slug')),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creaci\xf3n')),
                ('fecha_modificacion', models.DateTimeField(auto_now=True, verbose_name='\xdaltima modificaci\xf3n', db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_en', models.CharField(max_length=255, unique=True, null=True, verbose_name='Nombre', db_index=True)),
                ('nombre_es', models.CharField(max_length=255, unique=True, null=True, verbose_name='Nombre', db_index=True)),
                ('slug', models.SlugField(help_text='Es parte de la URL. Se crea autom\xe1ticamente a partir del nombre del producto en ingl\xe9s. El sistema se asegurar\xe1 de que sea \xfanico. Ejemplo:  Acetylcysteine -> acetylcysteine para http://e-lactancia/breastfeeding/acetylcysteine/product.', max_length=100, verbose_name='Slug')),
